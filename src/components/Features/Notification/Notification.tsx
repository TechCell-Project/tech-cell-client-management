...
export const Notification = memo(() => {
  ...
  const notifyTabs = useMemo(() => {
    return [
      { name: 'Tất cả', component: <NotificationList status='all' onClose={() => setAnchorEl(null)} /> },
      { name: 'Chưa đọc', component: <NotificationList status='unread' onClose={() => setAnchorEl(null)} /> },
    ];
  }, []);
